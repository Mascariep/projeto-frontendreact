import {
    ...
    BoxPedidoEspaco, 
    BoxPedidoProdutos, 
    BoxPedidoProdutosItens} from "./styledCarrinhoCompleto"
...
function CarrinhoCompleto(props){
    ...
    const frete = totalCarrinho < 200 ? 18 :  0
    let totalCompra = (totalCarrinho + frete)
        ...
        <ContainerPedido>
            ...
            <ResumoPedido>
                <div>
                    ...
                    <div><span>x{qtdTotalCarrinho} produto</span><span>R$ {totalCarrinho.toFixed(2)}</span></div><br/>
                    <div><span>Frete</span><span>R$ {frete}</span></div><br/>
